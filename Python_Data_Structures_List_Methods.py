# Python Data Structures List Methods
...
# denote that the parameter is optional, not that you should type square brackets at that position. 
...
fruits.reverse()   # Displays ['banana', 'apple', 'kiwi', 'banana', 'pear', 'apple', 'orange']

fruits.append('grape')
fruits.sort()      # Displays ['apple', 'apple', 'banana', 'banana', 'grape', 'kiwi', 'orange', 'pear']
